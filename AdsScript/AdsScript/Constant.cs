...
public static class Constant
{
    ...
    //   		#endif
    //   		#if UNITY_ANDROID
    //	Logging.Log("Business Is:: " + inAppType +":" + amount +":" +  itemId  );  
...
#if UNITY_IPHONE
    		Logging.Log("event Is:: "+eventName);   
...
//		FB.LogAppEvent(eventName);
    ...
    //    		Logging.Log("Prog:: "+status.ToString() +":"+ point+ CurrEP + ":"+ phase);   

    //    		GameAnalytics.NewProgressionEvent(status, world, point + currentEpisode, phase, prize);
    //#endif
    //#if UNITY_ANDROID

    //                Logging.Log("Prog:: "+status.ToString() +":"+ point+ currentEpisode + ":"+ phase);   
...
#if UNITY_IPHONE
		Logging.Log("Prog: : "+  GAResourceFlowType.Sink.ToString() +":"+ currency+":"+amount.ToString() + ":"+  itemType + ":"+ itemId ) ;   
    		GameAnalytics.NewResourceEvent(flowType  , currency, amount,   itemType , itemId );
		//FB.LogPurchase(amount, "USD", iapParameters);
#endif
#if UNITY_ANDROID
        Logging.Log("resource:: " + flowType.ToString() + ":" + ":" + currency + ":" + amount.ToString() + ":" + itemType + ":" + itemId);
    ...
    public static bool Check_Firebase = false;
